...
def update_graph(i, date_plot, t_load_middle_plot, t_evap_in_plot, t_evap_out_plot, t_cond_in_plot,
    ...
    p_flow_out_plot.append(p_flow_out[0]+1)
    p_flow_out_plot = p_flow_out_plot[-samples:]
    ax_p_flow_out.clear()

    p_cond_in_plot.append(p_cond_in[0]+1)
    p_cond_in_plot = p_cond_in_plot[-samples:]
    ax_p_cond_in.clear()

    p_evap_out_plot.append(p_evap_out[0]+1)
    ...
    flowmeter_density_plot.append(flowmeter_density[0])
    flowmeter_density_plot = flowmeter_density_plot[-samples:]
    ax_flowmeter_density.clear()

    flowmeter_flow_plot.append(flowmeter_flow[0])
    flowmeter_flow_plot = flowmeter_flow_plot[-samples:]
    ax_mass_flow.clear()
    ...
    ax_flowmeter_density.plot(date_plot, flowmeter_density_plot, color='b', zorder=1, label='density')
    ax_flowmeter_density.scatter(date_plot[-1:], flowmeter_density_plot[-1:])
    ax_flowmeter_density.text(date_plot[-1], flowmeter_density_plot[-1],"  {}".format(flowmeter_density_plot[-1], ha='right', size='medium'))
    ax_flowmeter_density.legend(loc="upper left")
    ax_flowmeter_density.tick_params(axis='x', labelrotation=45)

    ax_mass_flow.plot(date_plot, flowmeter_flow_plot, color='b', zorder=1, label='mass_flow')
    ax_mass_flow.scatter(date_plot[-1:], flowmeter_flow_plot[-1:])
    ax_mass_flow.text(date_plot[-1], flowmeter_flow_plot[-1], "  {}".format(flowmeter_flow_plot[-1], ha='right', size='medium'))
    ax_mass_flow.legend(loc="upper left")
    ax_mass_flow.tick_params(axis='x', labelrotation=45)
...
ax_flowmeter_density = plt.subplot(338)
ax_mass_flow = plt.subplot(339)
...
ax_flowmeter_density.set_facecolor('w')
ax_mass_flow.set_facecolor('w')
